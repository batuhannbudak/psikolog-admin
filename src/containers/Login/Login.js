...
const Login = ({ setIsLoggedIn }) => {
  ...
  return (
    <div className='h-full w-full flex bg-navy-50'>
      <div className="m-auto bg-white h-92 w-120 radius shadow-xs">
        <div className="text-center pt-10 flex flex-col gap-4">
          ...
          <span className='font-bold color-gray-200'>Email ve şifreniz ile giriş yapınız.</span>
        </div>
        <form className="pt-4" onSubmit={handleSubmit}>
          ...
          <div className="flex px-4 pt-4">
            ...
            >
              Giriş Yap
              {isLoading && <LoadingDots backgroundColor="#fff" />}
            </button>
          </div>
        </form>
      </div>
